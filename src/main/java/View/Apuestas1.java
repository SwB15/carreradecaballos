 ...
 * @author SwichBlade15
 */
public class Apuestas1 extends javax.swing.JDialog {
    ...
    public Apuestas1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        if (fechaInicioChooser != null && fechaFinChooser != null) {
            if (fechaInicioChooser.compareTo(fechaFinChooser) > 0) {
                ...
                try {
                    ...
                    Logger.getLogger(Apuestas1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Apuestas1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Apuestas1 dialog = new Apuestas1(new javax.swing.JFrame(), true);
